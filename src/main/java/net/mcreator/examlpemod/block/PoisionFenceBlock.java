...
public class PoisionFenceBlock extends ExamlpeModModElements.ModElement {
	@ObjectHolder("examlpe_mod:poision_fence")
	public static final Block block = null;
	public PoisionFenceBlock(ExamlpeModModElements instance) {
		super(instance, 28);
	}
