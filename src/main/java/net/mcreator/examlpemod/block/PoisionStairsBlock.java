...
public class PoisionStairsBlock extends ExamlpeModModElements.ModElement {
	@ObjectHolder("examlpe_mod:poision_stairs")
	public static final Block block = null;
	public PoisionStairsBlock(ExamlpeModModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("poision_stairs");
		}
