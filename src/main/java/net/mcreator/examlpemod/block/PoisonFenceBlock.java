...
public class PoisonFenceBlock extends ExamlpeModModElements.ModElement {
	@ObjectHolder("examlpe_mod:poison_fence")
	public static final Block block = null;
	public PoisonFenceBlock(ExamlpeModModElements instance) {
		super(instance, 65);
	}
