...
public class PoisonLeavesBlock extends ExamlpeModModElements.ModElement {
	@ObjectHolder("examlpe_mod:poison_leaves")
	public static final Block block = null;
	public PoisonLeavesBlock(ExamlpeModModElements instance) {
		super(instance, 62);
	}
