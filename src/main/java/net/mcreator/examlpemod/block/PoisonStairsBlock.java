...
public class PoisonStairsBlock extends ExamlpeModModElements.ModElement {
	@ObjectHolder("examlpe_mod:poison_stairs")
	public static final Block block = null;
	public PoisonStairsBlock(ExamlpeModModElements instance) {
		super(instance, 63);
	}
