...
public class PoisionAxeItem extends ExamlpeModModElements.ModElement {
	@ObjectHolder("examlpe_mod:poision_axe")
	public static final Item block = null;
	public PoisionAxeItem(ExamlpeModModElements instance) {
		super(instance, 45);
	}
