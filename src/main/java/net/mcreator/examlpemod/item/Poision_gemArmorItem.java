...
public class Poision_gemArmorItem extends ExamlpeModModElements.ModElement {
	@ObjectHolder("examlpe_mod:poision_gem_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("examlpe_mod:poision_gem_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("examlpe_mod:poision_gem_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("examlpe_mod:poision_gem_armor_boots")
	public static final Item boots = null;
	public Poision_gemArmorItem(ExamlpeModModElements instance) {
		super(instance, 17);
	}
