...
public class Poision_gemHoeItem extends ExamlpeModModElements.ModElement {
	@ObjectHolder("examlpe_mod:poision_gem_hoe")
	public static final Item block = null;
	public Poision_gemHoeItem(ExamlpeModModElements instance) {
		super(instance, 11);
	}
...
, new Item.Properties().group(ItemGroup.TOOLS)) {
		}.setRegistryName("poision_gem_hoe"));
	}
}
